    ...
    return (
        <View style={{ flexDirection: 'column', padding: 5, backgroundColor: backgroundColor, width: screenWidth, margin: 0.5 }}>
            <View style={{ flexDirection: 'row',  backgroundColor: backgroundColor, width: screenWidth - 10 }}>
                <View style={{ flex: 4 }}>
                    <Text style={{ ...styles.title, flex: 3, padding: 0, color: 'white', fontWeight: 'bold', fontSize: 18 }}> {props.item.name} </Text>

                    <Text style={{ ...styles.title, flex: 2, padding: 0, color: 'white', fontSize: 12 }}> {props.item.category} </Text>

                </View>
                <View style={{ flex: 4 }}>
                    <Text style={{ ...styles.title, flex: 2, padding: 0, color: 'white', fontSize: 14 }}> ₹ {props.item.amount} </Text>
